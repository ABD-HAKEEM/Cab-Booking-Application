...
namespace Cab_Booking_Application
{
    public class Order
    {
        ...
        public Order(string id, string cust_Name, string date, string order_Id, float cost, string start_Date, string end_Date, string start_Time, string end_Time, string from_Loc, string to_Loc, int with_Driver, string veh_ID)
        {
            Id = id;
            Cust_Name = cust_Name;
            Date = date;
